function processQuestion(chosenQuestionNumber, transported = 0) {
    ...
    let manualTimer = window.config.style.config.options['manual-timer'];
    ...
    if (manualTimer) {
        ...
        document.getElementsByClassName("timer")[0].addEventListener("click", startCountdown, { once: true });
